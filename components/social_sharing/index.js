      ...
      $('[data-partial="social-share"]').each(function () {
        ...
        if (_self.hasClass('article-social-share-facebook')) {
          ...
          _self.click(function (ev) {
            window.open(
              'https://www.facebook.com/sharer.php?u=' + _self.find('a').data('social-share-url'),
              '_blank',
          ...
          _self.click(function (ev) {
            ...
            window.open(
              'https://twitter.com/intent/tweet?text=Radio%20-%20&amp;url=' + _self.find('a').data('social-share-url') + '&amp;original_referer=',
              '_blank',
              'width=600,height=300'
            )
          })
