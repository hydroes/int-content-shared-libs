...
pug_html = pug_html + "\u003Csource" + (pug_attr("srcset", noImage.lg.url, true, false)+" media=\"(min-width: 439px)\"") + "\u002F\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attr("src", noImage.sm.url, true, false)+pug_attr("alt", image.altText, true, false)) + "\u002F\u003E\u003C\u002Fpicture\u003E";
}
pug_html = pug_html + "\u003C\u002Fa\u003E";
