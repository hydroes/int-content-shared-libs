...
let paginates = window.bauerSharedLibs.pug.helpers.paginate(data)
...
;pug_debug_line = 4;pug_debug_filename = "\u002FUsers\u002Fjoegasewiczadmin\u002FDocuments\u002Fwork\u002Fshared-components\u002Fcomponents\u002Fpagination\u002Fpagination.pug";
// iterate paginates
;(function(){
  var $$obj = paginates;
  if ('number' == typeof $$obj.length) {
      for (var pug_index0 = 0, $$l = $$obj.length; pug_index0 < $$l; pug_index0++) {
        var paginate = $$obj[pug_index0];
;pug_debug_line = 5;pug_debug_filename = "\u002FUsers\u002Fjoegasewiczadmin\u002FDocuments\u002Fwork\u002Fshared-components\u002Fcomponents\u002Fpagination\u002Fpagination.pug";
...
pug_html = pug_html + "\u003Ca" + (pug_attr("class", pug_classes([paginate.isActive ? 'pagination__link--active' : 'pagination__link'], [true]), false, false)+pug_attr("href", paginate.href, true, false)) + "\u003E";
;pug_debug_line = 6;pug_debug_filename = "\u002FUsers\u002Fjoegasewiczadmin\u002FDocuments\u002Fwork\u002Fshared-components\u002Fcomponents\u002Fpagination\u002Fpagination.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = paginate.display) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003C\u002Fli\u003E";
      }
  } else {
    var $$l = 0;
