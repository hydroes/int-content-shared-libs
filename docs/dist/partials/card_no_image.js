...
pug_html = pug_html + "\u003Cimg" + (pug_attr("src", data.placeholderImageSmall, true, false)+pug_attr("alt", data.placeholderAltText, true, false)) + "\u002F\u003E\u003C\u002Fpicture\u003E";
}}.call(this,"data" in locals_for_with?locals_for_with.data:typeof data!=="undefined"?data:undefined,"settings" in locals_for_with?locals_for_with.settings:typeof settings!=="undefined"?settings:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;}