...
if (window.bauerSharedLibs._.has(data, 'asset')) {
...
if (window.bauerSharedLibs._.has(settings,'stationHeaderLogoSVG')) {
...
var primaryLink = window.bauerSharedLibs.pug.helpers.primarySyndicateLink(data)
