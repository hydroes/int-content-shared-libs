...
pug_html = pug_html + "\u003Csource" + (pug_attr("type", image.sm.mimeType, true, false)+pug_attr("srcset", image.sm.url, true, false)+" media=\"(min-width: 480px)\"") + "\u002F\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attr("src", image.xs.url, true, false)+pug_attr("alt", image.altText, true, false)) + "\u002F\u003E\u003C\u002Fpicture\u003E";
}
else {
...
pug_html = pug_html + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Farticle\u003E";}.call(this,"data" in locals_for_with?locals_for_with.data:typeof data!=="undefined"?data:undefined,"image" in locals_for_with?locals_for_with.image:typeof image!=="undefined"?image:undefined,"noImage" in locals_for_with?locals_for_with.noImage:typeof noImage!=="undefined"?noImage:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined,"window" in locals_for_with?locals_for_with.window:typeof window!=="undefined"?window:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;}