...
pug_html = pug_html + "\u003Csource" + (pug_attr("type", images.sm.mimeType, true, false)+pug_attr("srcset", images.sm.url, true, false)+" media=\"(min-width: 480px)\"") + "\u002F\u003E";
...
pug_html = pug_html + "\u003Cimg" + (pug_attr("src", images.xs.url, true, false)+pug_attr("alt", images.altText, true, false)) + "\u002F\u003E\u003C\u002Fpicture\u003E";
}
else {
